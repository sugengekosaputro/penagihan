...
<table border="0"  style="width:100%;">
  <tr valign="top" align="left">
    <th style="width:25%"><img width="220px" height="70px" src="<?php echo base_url('assets/upload/UDBBB.jpeg'); ?>" alt="UDBBB"></th>
  ...
  <tr valign="top">
    ...
    <td>Tuan/Toko&nbsp;: blabla</td> 
  </tr>
  <tr valign="top">
    <td>Telp</td>
    <td>: 0343-6750665<br>&nbsp;&nbsp;+6281217155793</td>
    <td valign="top">Alamat&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;: jl customer</td> 
  </tr>
  <tr valign="top">
    <td>Email </td>
...
<table border="1" style="width:100%; border-collapse: collapse;">
  ...
  <tr  style="border-bottom:1pt solid white;" valign="top">
      <td style="border-bottom:1pt solid white; ">15-01-2018</td>
      <td style="border-bottom:1pt solid white; " align="right">24</td>
      <td style="border-bottom:1pt solid white;" align="left">Kg</td>
      <td style="border-bottom:1pt solid white; ">Pre strech film / wrapping 300 mt</td>
      <td style="border-bottom:1pt solid white; ">95,000</td>
      <td style="border-bottom:1pt solid white; ">3,240,000</td>
  </tr>
  <tr valign="top">
      <td >15-01-2018</td>
      <td align="right">24</td>
      <td align="left">Kg</td>
      <td>Pre strech film / wrapping 300 mt</td>
      <td>95,000</td>
      <td>3,240,000</td>
  </tr>
  <tr valign="top" style="">
  ...
  <tr  style="border-bottom:1pt solid white;padding-top:20px" valign="top">
      ...
      <td style="border-bottom:1pt solid black; ">Rp. 3,240,000</td>
  </tr>
  <tr  style="border-bottom:1pt solid white;padding-top:20px" valign="top">
      <td style="border:1pt solid white; border-top:1pt solid black; padding-top:20px"></td>
      <td style="border:1pt solid white; border-top:1pt solid black; padding-top:20px" align="right"></td>
      ...
      <td style="border-bottom:1pt solid black; ">Rp. 2,240,000</td>
  </tr>
  <tr  style="border-bottom:1pt solid white;padding-top:20px" valign="top">
      <td style="border:1pt solid white; border-top:1pt solid black; padding-top:20px"></td>
      <td style="border:1pt solid white; border-top:1pt solid black; padding-top:20px" align="right"></td>
      ...
      <td style="border-bottom:1pt solid black; ">Total</td>
      <td style="border-bottom:1pt solid black; ">Rp. 1,240,000</td>
  </tr>
 </table>
