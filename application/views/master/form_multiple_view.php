              ...
              <form class="form-horizontal form-label-left input_mask" id="form">
                <div id="dynamicField">
                  <div class="col-md-5 col-sm-5 col-xs-12 form-group">
                    <input type="text" class="form-control" id="idBarang" name="barang[]" placeholder="Barang">
                  </div>
                  <div class="col-md-3 col-sm-5 col-xs-12 form-group">
                    <input type="text" class="form-control" id="idJumlah" name="jumlah[]" placeholder="Jumlah">
                  </div>
                </div>
